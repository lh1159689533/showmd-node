...
const common = (level, message = '', params = '') => {
  ...
  wlogger[level](`${message}${params}`);
};

const logger = {
  info(message, params) {
    common('info', message, params);
  },
  debug(message, params) {
    common('debug', message, params);
  },
  warn(message, params) {
    common('warn', message, params);
  },
  error(message, params) {
    console.trace();
    common('error', message, params);
  }
}
